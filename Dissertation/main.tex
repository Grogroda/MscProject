...
\noindent where $\rho_{DE}$ and $P_{DE}$ are the dark energy's pressure and density contribution and $\delta$ indicates the perturbation of these quantities. 
...
Figure ??? shows this influence on the CMB temperature autocorrelation spectrum.

IMAGENS

%%COMPLEMENTAR AQUI COM: VELOCIDADE DO SOM (OU SEI LÁ)
%ADICIONAR OS PLOTS QUE EU FIZ DA INFLUÊNCIA DA DARK ENERGY NO CTT (colocar essa seção depois de falar do Ctt?)
