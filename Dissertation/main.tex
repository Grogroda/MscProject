...
\centering
    ...
    \end{tabular}
    \caption{. Values extracted from \cite{cross_corr:Afshordi}.}
...
SHOW THE PROBABILITY FUNCTION WE ARE ATTEMPTING TO OPTIMIZE, WHICH IS COMPARED WITH THE HISTOGRAMS OF 0 CROSS-CORRELATION I MADE, THE HEAT PLOTS EXPLORING THE REGIONS OF INTEREST AND THE FINAL RESULT OF THE MINIMIZER
