...
\begin{figure}[!htb]
	...
	\end{subfigure}
	\caption{Mollweide projection of two instances of maps synthesized using HEALPix with the procedure presented. (LEGENDAS MUITO PEQUENAS, VOU REFAZER ESSES PLOTS)}
	\label{fig:SynthMaps}
\end{figure} 
...
\begin{figure}[!htb]
	...
	\includegraphics[width=\linewidth]{Imagens/av_plot_ctt_N1e4.png}
	%\caption{cap1}
	%\label{subfig:synthmaps_ctt}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.32\textwidth}
	\includegraphics[width=\linewidth]{Imagens/av_plot_cgg_N1e4.png}
	%\caption{cap2}
	%\label{subfig:synthmaps_cgg}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.32\textwidth}
	\includegraphics[width=\linewidth]{Imagens/av_plot_ctg_N1e4.png}
	%\caption{cap3}
	%\label{subfig:synthmaps_ctg}
	\end{subfigure}
	\caption{Comparison between theoretical cross-correlation spectrum and the averages of the $C_\ell$ calculated from $10^4$ synthesized maps using the procedure presented in this section. (VOU MUDAR TUDO PARA INGLÊS E AUMENTAR A FONTE)}
