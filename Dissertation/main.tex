...
\section{Dark Energy Models}\label{sect:dark_energy}
...
Figures ??? show the influence of different parametrizations and parameter values on the CMB temperature autocorrelation spectrum.
...
\begin{figure}[!htb]
    ...
    \caption{Matter power spectrum calculated as a function of $k/h$, where $h=H_0/(100\text{ km/s/Mpc})$, using the HALOFIT with cosmological parameters according to Planck's best fit results\cite{Planck_results}.}
    \label{fig:matter_PS}
\end{figure}
