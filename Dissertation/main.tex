...
discuss the fact that, using the likelihoods shown previously, even for a single parameter (OmegaM), yielded markov chains with an incredibly low acceptance rate. discuss possible reasons for that.  
