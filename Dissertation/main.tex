...
%\end{equation}
\begin{equation}
    \dot{\delta}+\frac{ik}{a}v=-3\dot{\Phi},
\end{equation}
\begin{equation}
    \dot{v}+\frac{H}{a}v=-\frac{ik}{a}\Psi,
\end{equation}
\begin{equation}
...
The HALOFIT model is a semi-analytical method to determine a non-linear solution for $P(k,z)$.  EXPLAIN HALOFIT? DISCUSS WHY USING HALOFIT IS IMPORTANT
...
By using equation \eqref{ch2:Theta_spherical harmonics} one can express $a_{\ell m}$ in terms of $\Theta_\ell$, which can be expanded using equation \eqref{ch2:Thetal_approx}, this expansion and the correlation definitions allows us to find analytical expressions for all correlation functions discussed so far using the approximations discussed, but we can also use the ISW contribution to equation \eqref{ch2:Thetal_approx} to calculate the sole contribution of the ISW effect to the full correlation spectra. 
