...
\begin{frame}{The $\Lambda$CDM Model}
	...
	\begin{figure}[t]
	\centering
	\includegraphics[width=.5\linewidth, height=.5\textheight]{pic/OmegaL_riess98.png}
	...
	\begin{figure}[t]
	\centering
	\includegraphics[width=.85\linewidth]{pic/polarization_cross_spec.png}
...
\begin{frame}{CMB Autocorrelation Contributions}
	\begin{figure}
	\centering
	\includegraphics[width=.6\linewidth]{pic/CMB_contributions.png}
...
\begin{frame}{Future Prospects}
	...
	\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{pic/gamma_constraints.png}
...
\begin{frame}{Bias Factor Fit}
	...
	\begin{figure}
	\centering
	\includegraphics[width=.9\linewidth]{pic/bias_factor_fit.png}
	\end{figure}
	\end{columns}
\end{frame}
...
\begin{frame}{Bias Factor Fit}
	\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{pic/bg_table.png}
	\end{figure}
...
\begin{frame}{Planck Selection Functions}
	\begin{figure}
	\centering
	\includegraphics[width=.45\linewidth]{pic/selection_Planck.png}
...
\begin{frame}{Influence of Parameters on $C_\ell^{tt}$}
	\begin{figure}
	\centering
	\includegraphics[width=.9\linewidth]{pic/Ctt_ParVar1.png}
...
\begin{frame}{Influence of Parameters on $C_\ell^{tt}$}
	\begin{figure}
	\centering
	\includegraphics[width=.9\linewidth]{pic/Ctt_ParVar2.png}
	\caption{Extracted from Alexandra T. Petreca "The impact of systematic effects on the cosmic distance ladder" (2024)}
	\label{fig:ParVar2}
	\end{figure}
\end{frame}
...
\begin{frame}{Influence of Parameters on $C_\ell^{tt}$}
	\begin{figure}
	\centering
	\includegraphics[width=.9\linewidth]{pic/Ctt_ParVar3.png}
	\caption{Extracted from Alexandra T. Petreca "The impact of systematic effects on the cosmic distance ladder" (2024)}
	\label{fig:ParVar3}
	\end{figure}
\end{frame}
