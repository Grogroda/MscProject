...
data_full=pd.read_csv("../tables/COM_PowerSpect_CMB-TT-full_R3.01.csv", header=[0])
data_binned=pd.read_csv("../tables/COM_PowerSpect_CMB-TT-binned_R301.csv", header=[0])
