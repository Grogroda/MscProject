...
python3 profile_OmegaM.py -n 9 -b 1 -N 20000000 -c 'ctg' --Omin 0.1 --Omax 0.9 > like_profiles/band1_profile_parallel.log 2>&1 

#python3 profile_OmegaM.py -h -b -n -N -c --Omin --Omax
#h=help, b=band (1,2,3,4 or 'min'), n=number of processes
#N=number of MC calls, -c='ctg' or 'cgg'
